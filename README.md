...
- [GameHandlers](https://github.com/sopra-fs21-group-10/td-client/blob/master/src/components/game/Game.js#L1722) (such as handlePath, handleGrid, handleMinions, handleTowers, handleProjectiles, handleShop, handleGame and handleGameStatus)<br>
...
- [Animate function](https://github.com/sopra-fs21-group-10/td-client/blob/master/src/components/game/Game.js#L1722):<br>
Calls the different handlers in a certain frame interval.
- [Helper functions](https://github.com/sopra-fs21-group-10/td-client/blob/master/src/components/game/Game.js#L2401) (especially the isCollide)<br>
